...
function comment_create()
{
	...
	if(comment_para_id > 3000000){
		...
		if(typeof comment_para_count_id != 'undefined' && comment_para_count_id){
			var array = comment_para_count_id.split('|');
			for(var i=0; i<array.length; ++i){
				var el = document.getElementById(array[i]);
				if(el && el.parentNode && el.parentNode.href)
					el.parentNode.href = el.parentNode.href.replace('comment5', 'comment4');
			}
		}
		setFrameSrc(comment_para_id);
	}
})()/*  |xGv00|b6a8bfb03f14f096849c6594918fe55c */